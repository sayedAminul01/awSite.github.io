...
class QuizApp {
    ...
    loadQuizData() {
        ...
        this.quizData = {
            'day_1': day_1Questions,
            'day_2': day_2Questions,
            'day_3': day_3Questions,
            'day_4': day_4Questions,
            'day_5': day_5Questions,
            'day_6': day_6Questions,
            'day_7': day_7Questions,
            'day_8': day_8Questions,
            'day_9': day_9Questions,
            'day_10': day_10Questions,
        };
    }
